...
enum xmrstak_algo_id
{
	...
	cryptonight_zum = start_derived_algo_id,
...
// cryptonight zum (the mask is not using the full 256kib scratchpad)
constexpr uint32_t CN_ZUM_MASK = 0x1FFF0;
...
inline xmrstak_algo POW(xmrstak_algo_id algo_id)
{
	...
	static std::array<xmrstak_algo, 4> derived_pow =
		{{
			{cryptonight_zum, cryptonight_monero_v8, CN_ITER / 8, CN_MEMORY / 8, CN_ZUM_MASK},
